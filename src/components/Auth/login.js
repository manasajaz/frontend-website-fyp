  ...
  const handlelogin = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("token", response.data.token);
        window.location.href = "https://rococo-strudel-a6614e.netlify.app/";
  ...
  return (
    ...
    <div className='grid grid-cols-10 gap-5 lg:p-5 p-2 bg-red-50 min-h-screen'>
      <div className='lg:col-span-4 col-span-12 row-span-6 '>
        <img className='w-full object-cover object-left hover:object-center transition-all duration-500 h-full w-full' src="https://tateeda.com/wp-content/uploads/2020/09/11.jpg"></img>
      </div>
